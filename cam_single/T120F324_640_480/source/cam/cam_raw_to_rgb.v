...
begin
   ...
   begin
      ...
      r_bayer_00_01_0P_0 <= (line_count == {LINE_COUNT_BIT{1'b0}}) ? i_p_01[P_DEPTH-1:0] : i_p_00[P_DEPTH-1:0];
      r_bayer_00_01_0P_1 <= (line_count == {LINE_COUNT_BIT{1'b0}}) ? i_p_01[PW-1:P_DEPTH] : i_p_00[PW-1:P_DEPTH];
      r_bayer_01_01_0P_0 <= i_p_01[P_DEPTH-1:0];
      r_bayer_01_01_0P_1 <= i_p_01[PW-1:P_DEPTH];

      if (pixel_count == {PIX_COUNT_BIT{1'b0}})
      begin
         r_bayer_11_00_1P_0 <= i_p_11[P_DEPTH-1:0];
         r_bayer_11_00_1P_1 <= i_p_11[PW-1:P_DEPTH];
         r_bayer_00_00_1P_0 <= i_p_00[P_DEPTH-1:0];
         r_bayer_00_00_1P_1 <= i_p_00[PW-1:P_DEPTH];
         r_bayer_01_00_1P_0 <= i_p_01[P_DEPTH-1:0];
         r_bayer_01_00_1P_1 <= i_p_01[PW-1:P_DEPTH];

         r_bayer_11_11_2P_0 <= i_p_11[P_DEPTH-1:0];
         r_bayer_11_11_2P_1 <= i_p_11[PW-1:P_DEPTH];
         r_bayer_00_11_2P_0 <= i_p_00[P_DEPTH-1:0];
         r_bayer_00_11_2P_1 <= i_p_00[PW-1:P_DEPTH];
         r_bayer_01_11_2P_0 <= i_p_01[P_DEPTH-1:0];
         r_bayer_01_11_2P_1 <= i_p_01[PW-1:P_DEPTH];
      end
      else
      begin
