...
`include "evsoc_defines.v"

module edge_vision_soc #(
    //Input frame resolution from MIPI Rx
    parameter MIPI_FRAME_WIDTH  = `MIPI_FRAME_WIDTH,
    parameter MIPI_FRAME_HEIGHT = `MIPI_FRAME_HEIGHT,
    //Actual frame resolution used for subsequent processing (after cropping/scaling)
    parameter FRAME_WIDTH  = `FRAME_WIDTH,  //Multiple of 2 - To match with 2PPC pixel data.
    parameter FRAME_HEIGHT =`FRAME_HEIGHT  //Multiple of 2 - To preserve bayer format prior to raw2rgb conversion.
) (
    //-------------------------------------------------------------------------
    // System Clocks
    //-------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
    // HyperRAM PLL / Clock Calibration
    //-------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
    // MIPI CSI Rx - Camera Data Lane 0
    //-------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
    // MIPI CSI Rx - Camera Data Lane 1
    //-------------------------------------------------------------------------
...
`endif
    ...
    //-------------------------------------------------------------------------
    // MIPI DSI Tx - Display Panel Clock Lane
    //-------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
    // MIPI DSI Tx - Display Panel Data Lanes
    //-------------------------------------------------------------------------
    ...
    input  wire sw6,
    input  wire sw7,
    input  wire user_dip0,    // Demo mode select
...
`endif
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - Reset and Clock Domains
  ///////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - MIPI CSI Rx / Camera
  ///////////////////////////////////////////////////////////////////////////////
  ...
  // Two-stage synchronizer registers for CDC (MIPI clock domain)
  ...
  (* async_reg = "true" *)reg  [ 15:0
  ] r_mipi_rx_data_HS_IN_0_2P;

  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - Camera/Display APB Control
  ///////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - MIPI DSI Tx / Display Panel (AXI-Lite for panel config)
  ///////////////////////////////////////////////////////////////////////////////
  ...
  wire         io_w_valid;
  wire         io_w_ready;
  wire [127:0] io_w_payload_data;
  wire [ 15:0] io_w_payload_strb;
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - Hardware Accelerator AXI4
  ///////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - AXI Interconnect (SoC side, half-duplex)
  ///////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - AXI Interconnect Slave 0 (SoC → Interconnect)
  ///////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - AXI Interconnect Slave 1 (DMA → Interconnect)
  ///////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - AXI Interconnect Master (Interconnect → HyperRAM)
  ///////////////////////////////////////////////////////////////////////////////
...
`endif
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // MIPI CSI Rx - Input Data Capture and Synchronization
  ///////////////////////////////////////////////////////////////////////////////

  // Concatenate serial data bytes from each lane
  ...
  // LVDS termination and enable outputs
  ...
  // Two-stage synchronizer: sample LP/HS inputs on byte clock for CDC
  always @(negedge i_arstn or posedge i_cam_ck_CLKOUT_0) begin
    if (~i_arstn) begin
  ...
  csi2_rx_cam #() u_csi2_rx_cam (
      ...
      // Data lanes (2 active, rest unused)
      ...
      .u_dly_enable_D     (),
      .u_dly_inc_D        (),
      // AXI config port (unused - tied off)
      .axi_clk            (1'b0),
      .axi_reset_n        (1'b0),
      .axi_awaddr         (6'b0),
      .axi_awvalid        (1'b0),
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Camera - I2C and Configuration Done
  ///////////////////////////////////////////////////////////////////////////////      

  assign mipi_i2c_0_io_sda_writeEnable = !mipi_i2c_0_io_sda_write;
  assign mipi_i2c_0_io_scl_writeEnable = !mipi_i2c_0_io_scl_write;

  // Track camera configuration completion (set once mipi_rstn goes high)
  always @(posedge i_systemClk) begin
    if (io_systemReset) begin
      w_cam_confdone <= 1'b0;
    end else begin
      w_cam_confdone <= (mipi_rstn) ? 1'b1 : w_cam_confdone;
    end
  end
...
`endif
  ...
  always @(negedge i_arstn or posedge i_fb_clk) begin
    if (~i_arstn) begin
      ...
      if (~r_rst_cnt[19]) begin
        r_rst_cnt <= r_rst_cnt + 1'b1;

        if (r_rst_cnt[18] && r_rst_cnt[17]) r_lcd_rstn <= 1'b0;
        else r_lcd_rstn <= 1'b1;
      end else r_lcd_rstn <= 1'b1;
    end
  end

  ///////////////////////////////////////////////////////////////////////////////
  // Display - Panel Initialization via AXI-Lite
  ///////////////////////////////////////////////////////////////////////////////

  panel_config #(
      .INITIAL_CODE("source/display/dsi/dsi_panel_1080p_reg.mem"),
      .REG_DEPTH   (9'd15)
  ) u_panel_config (
      .i_axi_clk(i_fb_clk),
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // MIPI DSI Tx - Display Panel Transmitter
  ///////////////////////////////////////////////////////////////////////////////
  ...
  dsi_tx_display u_dsi_tx_display (
      ...
      //AXI4-Lite Interface (panel configuration)
      .axi_clk    (i_fb_clk),
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Camera and Display APB3 Control / Debug
  ///////////////////////////////////////////////////////////////////////////////

  // FIFO status: [31:6] = 26'd0, [5:0] = 6 status bits
  ...
  // Reuse HyperRAM PLL output as memory clock
  ...
  // peripheralClk shared at 100 MHz (i_mipi_rx_pclk)
  // Note: if changed, update the corresponding clock pin in Interface Designer
  ...
  SapphireSoc u_risc_v (
      ...
      // APB Slave 1 (Cam/Display control)
      ...
      // DDR/Memory port (half-duplex ARW)
...
`endif
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Hardware Accelerator - AXI4 Interface
  ///////////////////////////////////////////////////////////////////////////////
  ...
  dma u_dma (
      ...
      .ctrl_PADDR     (io_apbSlave_1_PADDR),
      ...
      .read_arregion  (dma_arregion),              // Preserved from synthesis
      ...
      .write_awregion (dma_awregion),              // Preserved from synthesis
      ...
      // Channel 0: Camera (64-bit S2MM, to HyperRAM)
      ...
      // Channel 1: Unused output (tied off)
      .dat1_o_clk     (1'b0),
      .dat1_o_reset   (1'b0),
      .dat1_o_tvalid  (),
      .dat1_o_tready  (),
      ...
      .dat1_o_tdest   (),
      .dat1_o_tlast   (),
      // Channel 2: Display (64-bit MM2S, from HyperRAM)
      .dat2_o_clk     (i_sysclk_div_2),
      .dat2_o_reset   (~w_sys_dp_arstn),
      ...
      .dat2_o_tdest   (),
      .dat2_o_tlast   (),
      // Channel 3: HW Accel Write (32-bit S2MM, to HyperRAM)
      .dat3_i_clk     (i_systemClk),
      .dat3_i_reset   (io_systemReset),
      ...
      // Channel 4: HW Accel Read (32-bit MM2S, from HyperRAM)
      .dat4_o_clk     (i_systemClk),
      .dat4_o_reset   (io_systemReset),
      .dat4_o_tvalid  (hw_accel_dma_rvalid),
      .dat4_o_tready  (hw_accel_dma_rready),
      .dat4_o_tdata   (hw_accel_dma_rdata),
      .dat4_o_tkeep   (hw_accel_dma_rkeep),
      .dat4_o_tdest   (),
      .dat4_o_tlast   ()
  );

  ///////////////////////////////////////////////////////////////////////////////
  // AXI Interconnect - SoC Half-Duplex to Full-Duplex Conversion
  // Splits the combined ARW channel from SoC into separate AW and AR channels
  ///////////////////////////////////////////////////////////////////////////////

  // Write address channel (active when write=1)
  ...
  // Read address channel (active when write=0)
  ...
  assign soc_io_arw_ready = (soc_io_arw_payload_write) ? axi_inter_s0_awready 
                                                      : axi_inter_s0_arready;

  // DMA IDs (don't-care values for DMA controller)
  assign axi_inter_s1_awid = 8'hE0;
  assign axi_inter_s1_arid = 8'hE1;

  ///////////////////////////////////////////////////////////////////////////////
  // AXI Interconnect - 2-Slave to 1-Master (SoC + DMA → HyperRAM)
  ///////////////////////////////////////////////////////////////////////////////
  ...
  axi_interconnect #(
      ...
      .clk           (io_memoryClk),
      .rst           (io_systemReset),
      // Slave 0: SoC | Slave 1: DMA (packed concatenation, S1 in MSBs)
      ...
      // Master: HyperRAM controller (via half-duplex bridge)
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // AXI Full-to-Half-Duplex Bridge - Interconnect Master → HyperRAM Controller
  ///////////////////////////////////////////////////////////////////////////////
  ...
  axi_full_to_half_duplex #(
      ...
      .clk                     (io_memoryClk),
      .rst                     (io_systemReset),
      // Half-duplex output to HyperRAM controller
      ...
      // Full-duplex input from AXI interconnect master
