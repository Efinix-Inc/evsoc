...
module EfxDMA (
  ...
  output wire [4:0]    ctrl_interrupts,
  ...
  input  wire          dat3_i_tvalid,
  output wire          dat3_i_tready,
  input  wire [31:0]   dat3_i_tdata,
  input  wire [3:0]    dat3_i_tkeep,
  input  wire [3:0]    dat3_i_tdest,
  input  wire          dat3_i_tlast,
  ...
  output wire          dat2_o_tvalid,
  input  wire          dat2_o_tready,
  output wire [63:0]   dat2_o_tdata,
  output wire [7:0]    dat2_o_tkeep,
  output wire [3:0]    dat2_o_tdest,
  output wire          dat2_o_tlast,
  output wire          dat4_o_tvalid,
  input  wire          dat4_o_tready,
  output wire [31:0]   dat4_o_tdata,
  output wire [3:0]    dat4_o_tkeep,
  output wire [3:0]    dat4_o_tdest,
  output wire          dat4_o_tlast,
  input  wire          clk,
  input  wire          reset,
  input  wire          ctrl_clk,
  ...
  wire       [63:0]   core_io_outputs_2_payload_data;
  wire       [7:0]    core_io_outputs_2_payload_mask;
  ...
  wire       [4:0]    io_interrupts_buffercc_io_dataOut;
  ...
  wire       [63:0]   outputsAdapter_2_crossclock_fifo_io_pop_payload_data;
  wire       [7:0]    outputsAdapter_2_crossclock_fifo_io_pop_payload_mask;
  ...
  wire       [22:0]   readLogic_resized_cmd_payload_fragment_context;
  ...
  wire       [22:0]   readLogic_resized_rsp_payload_fragment_context;
  ...
  reg        [22:0]   interconnect_read_aggregated_cmd_rData_fragment_context;
  ...
  wire       [22:0]   readLogic_resized_rsp_combStage_payload_fragment_context;
  ...
  wire       [63:0]   io_pop_s2mPipe_payload_data_2;
  wire       [7:0]    io_pop_s2mPipe_payload_mask_1;
  wire       [3:0]    io_pop_s2mPipe_payload_sink_1;
  wire                io_pop_s2mPipe_payload_last_2;
  reg                 io_pop_rValidN_2;
  reg        [63:0]   io_pop_rData_data_2;
  reg        [7:0]    io_pop_rData_mask_1;
  reg        [3:0]    io_pop_rData_sink_1;
  reg                 io_pop_rData_last_2;
  wire                io_pop_s2mPipe_m2sPipe_valid_2;
  wire                io_pop_s2mPipe_m2sPipe_ready_2;
  wire       [63:0]   io_pop_s2mPipe_m2sPipe_payload_data_2;
  wire       [7:0]    io_pop_s2mPipe_m2sPipe_payload_mask_1;
  wire       [3:0]    io_pop_s2mPipe_m2sPipe_payload_sink_1;
  wire                io_pop_s2mPipe_m2sPipe_payload_last_2;
  reg                 io_pop_s2mPipe_rValid_2;
  reg        [63:0]   io_pop_s2mPipe_rData_data_2;
  reg        [7:0]    io_pop_s2mPipe_rData_mask_1;
  reg        [3:0]    io_pop_s2mPipe_rData_sink_1;
  reg                 io_pop_s2mPipe_rData_last_2;
  ...
  wire                io_outputs_2_s2mPipe_valid;
  reg                 io_outputs_2_s2mPipe_ready;
  wire       [63:0]   io_outputs_2_s2mPipe_payload_data;
  wire       [7:0]    io_outputs_2_s2mPipe_payload_mask;
  wire       [3:0]    io_outputs_2_s2mPipe_payload_sink;
  wire                io_outputs_2_s2mPipe_payload_last;
  reg                 io_outputs_2_rValidN;
  reg        [63:0]   io_outputs_2_rData_data;
  reg        [7:0]    io_outputs_2_rData_mask;
  reg        [3:0]    io_outputs_2_rData_sink;
  reg                 io_outputs_2_rData_last;
  wire                outputsAdapter_2_ptr_valid;
  wire                outputsAdapter_2_ptr_ready;
  wire       [63:0]   outputsAdapter_2_ptr_payload_data;
  wire       [7:0]    outputsAdapter_2_ptr_payload_mask;
  wire       [3:0]    outputsAdapter_2_ptr_payload_sink;
  wire                outputsAdapter_2_ptr_payload_last;
  reg                 io_outputs_2_s2mPipe_rValid;
  reg        [63:0]   io_outputs_2_s2mPipe_rData_data;
  reg        [7:0]    io_outputs_2_s2mPipe_rData_mask;
  reg        [3:0]    io_outputs_2_s2mPipe_rData_sink;
  ...
  wire       [22:0]   interconnect_read_aggregated_slaveModel_arbiterGen_oneToOne_arbiter_cmd_payload_fragment_context;
  ...
  wire       [22:0]   interconnect_read_aggregated_slaveModel_arbiterGen_oneToOne_arbiter_rsp_payload_fragment_context;
  ...
  EfxDMA_Core core (
    ...
    .io_read_rsp_payload_fragment_context  (interconnect_read_aggregated_slaveModel_arbiterGen_oneToOne_arbiter_rsp_payload_fragment_context[22:0] ), //i
    ...
    .io_outputs_2_ready                    (io_outputs_2_rValidN                                                                                   ), //i
    .io_outputs_2_payload_data             (core_io_outputs_2_payload_data[63:0]                                                                   ), //o
    .io_outputs_2_payload_mask             (core_io_outputs_2_payload_mask[7:0]                                                                    ), //o
    ...
    .io_inputs_0_payload_data              (io_pop_s2mPipe_m2sPipe_payload_data_1[63:0]                                                            ), //i
    ...
    .io_inputs_1_valid                     (io_pop_s2mPipe_m2sPipe_valid_2                                                                         ), //i
    .io_inputs_1_ready                     (core_io_inputs_1_ready                                                                                 ), //o
    .io_inputs_1_payload_data              (io_pop_s2mPipe_m2sPipe_payload_data_2[63:0]                                                            ), //i
    ...
    .io_inputs_1_payload_last              (io_pop_s2mPipe_m2sPipe_payload_last_2                                                                  ), //i
    .io_interrupts                         (core_io_interrupts[4:0]                                                                                ), //o
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_12 io_interrupts_buffercc (
    .io_dataIn  (core_io_interrupts[4:0]               ), //i
    .io_dataOut (io_interrupts_buffercc_io_dataOut[4:0]), //o
    .ctrl_clk   (ctrl_clk                              ), //i
    .ctrl_reset (ctrl_reset                            )  //i
  );
  EfxDMA_BmbSourceRemover readLogic_sourceRemover (
    ...
    .io_input_cmd_payload_fragment_context  (readLogic_resized_cmd_payload_fragment_context[22:0]                ), //i
  ...
  EfxDMA_StreamFifoCC_4 outputsAdapter_2_crossclock_fifo (
    .io_push_valid        (outputsAdapter_2_ptr_valid                                ), //i
    .io_push_ready        (outputsAdapter_2_crossclock_fifo_io_push_ready            ), //o
    .io_push_payload_data (outputsAdapter_2_ptr_payload_data[63:0]                   ), //i
    .io_push_payload_mask (outputsAdapter_2_ptr_payload_mask[7:0]                    ), //i
    .io_push_payload_sink (outputsAdapter_2_ptr_payload_sink[3:0]                    ), //i
    .io_push_payload_last (outputsAdapter_2_ptr_payload_last                         ), //i
    ...
    .io_pop_payload_data  (outputsAdapter_2_crossclock_fifo_io_pop_payload_data[63:0]), //o
    .io_pop_payload_mask  (outputsAdapter_2_crossclock_fifo_io_pop_payload_mask[7:0] ), //o
  ...
  EfxDMA_BsbDownSizerSparse outputsAdapter_2_sparseDownsizer_logic (
    ...
    .io_input_payload_data  (outputsAdapter_2_crossclock_fifo_io_pop_payload_data[63:0]         ), //i
    .io_input_payload_mask  (outputsAdapter_2_crossclock_fifo_io_pop_payload_mask[7:0]          ), //i
  ...
  assign dat3_i_tready = inputsAdapter_1_upsizer_logic_io_input_ready;
  assign io_pop_s2mPipe_valid_2 = (inputsAdapter_1_crossclock_fifo_io_pop_valid || (! io_pop_rValidN_2));
  assign io_pop_s2mPipe_payload_data_2 = (io_pop_rValidN_2 ? inputsAdapter_1_crossclock_fifo_io_pop_payload_data : io_pop_rData_data_2);
  assign io_pop_s2mPipe_payload_mask_1 = (io_pop_rValidN_2 ? inputsAdapter_1_crossclock_fifo_io_pop_payload_mask : io_pop_rData_mask_1);
  assign io_pop_s2mPipe_payload_sink_1 = (io_pop_rValidN_2 ? inputsAdapter_1_crossclock_fifo_io_pop_payload_sink : io_pop_rData_sink_1);
  assign io_pop_s2mPipe_payload_last_2 = (io_pop_rValidN_2 ? inputsAdapter_1_crossclock_fifo_io_pop_payload_last : io_pop_rData_last_2);
  always @(*) begin
    io_pop_s2mPipe_ready_2 = io_pop_s2mPipe_m2sPipe_ready_2;
    if(when_Stream_l375_6) begin
      io_pop_s2mPipe_ready_2 = 1'b1;
    end
  end

  assign when_Stream_l375_6 = (! io_pop_s2mPipe_m2sPipe_valid_2);
  assign io_pop_s2mPipe_m2sPipe_valid_2 = io_pop_s2mPipe_rValid_2;
  assign io_pop_s2mPipe_m2sPipe_payload_data_2 = io_pop_s2mPipe_rData_data_2;
  ...
  assign io_pop_s2mPipe_m2sPipe_payload_last_2 = io_pop_s2mPipe_rData_last_2;
  assign io_pop_s2mPipe_m2sPipe_ready_2 = core_io_inputs_1_ready;
  ...
  assign when_Stream_l375_7 = (! outputsAdapter_0_ptr_valid);
  ...
  assign when_Stream_l375_8 = (! outputsAdapter_1_ptr_valid);
  ...
  assign dat2_o_tvalid = outputsAdapter_1_crossclock_fifo_io_pop_valid;
  assign dat2_o_tdata = outputsAdapter_1_crossclock_fifo_io_pop_payload_data;
  assign dat2_o_tkeep = outputsAdapter_1_crossclock_fifo_io_pop_payload_mask;
  assign dat2_o_tdest = outputsAdapter_1_crossclock_fifo_io_pop_payload_sink;
  assign dat2_o_tlast = outputsAdapter_1_crossclock_fifo_io_pop_payload_last;
  assign io_outputs_2_s2mPipe_valid = (core_io_outputs_2_valid || (! io_outputs_2_rValidN));
  assign io_outputs_2_s2mPipe_payload_data = (io_outputs_2_rValidN ? core_io_outputs_2_payload_data : io_outputs_2_rData_data);
  assign io_outputs_2_s2mPipe_payload_mask = (io_outputs_2_rValidN ? core_io_outputs_2_payload_mask : io_outputs_2_rData_mask);
  assign io_outputs_2_s2mPipe_payload_sink = (io_outputs_2_rValidN ? core_io_outputs_2_payload_sink : io_outputs_2_rData_sink);
  assign io_outputs_2_s2mPipe_payload_last = (io_outputs_2_rValidN ? core_io_outputs_2_payload_last : io_outputs_2_rData_last);
  always @(*) begin
    io_outputs_2_s2mPipe_ready = outputsAdapter_2_ptr_ready;
    if(when_Stream_l375_9) begin
      io_outputs_2_s2mPipe_ready = 1'b1;
    end
  end

  assign when_Stream_l375_9 = (! outputsAdapter_2_ptr_valid);
  assign outputsAdapter_2_ptr_valid = io_outputs_2_s2mPipe_rValid;
  assign outputsAdapter_2_ptr_payload_data = io_outputs_2_s2mPipe_rData_data;
  assign outputsAdapter_2_ptr_payload_mask = io_outputs_2_s2mPipe_rData_mask;
  assign outputsAdapter_2_ptr_payload_sink = io_outputs_2_s2mPipe_rData_sink;
  assign outputsAdapter_2_ptr_payload_last = io_outputs_2_s2mPipe_rData_last;
  assign outputsAdapter_2_ptr_ready = outputsAdapter_2_crossclock_fifo_io_push_ready;
  assign dat4_o_tvalid = outputsAdapter_2_sparseDownsizer_logic_io_output_valid;
  assign dat4_o_tdata = outputsAdapter_2_sparseDownsizer_logic_io_output_payload_data;
  assign dat4_o_tkeep = outputsAdapter_2_sparseDownsizer_logic_io_output_payload_mask;
  assign dat4_o_tdest = outputsAdapter_2_sparseDownsizer_logic_io_output_payload_sink;
  assign dat4_o_tlast = outputsAdapter_2_sparseDownsizer_logic_io_output_payload_last;
  ...
  always @(posedge clk) begin
    if(reset) begin
      ...
      io_outputs_2_rValidN <= 1'b1;
      io_outputs_2_s2mPipe_rValid <= 1'b0;
    end else begin
      ...
      if(core_io_outputs_2_valid) begin
        io_outputs_2_rValidN <= 1'b0;
      end
      if(io_outputs_2_s2mPipe_ready) begin
        io_outputs_2_rValidN <= 1'b1;
      end
      if(io_outputs_2_s2mPipe_ready) begin
        io_outputs_2_s2mPipe_rValid <= io_outputs_2_s2mPipe_valid;
      end
    end
  end
  ...
  always @(posedge clk) begin
    ...
    if(io_pop_rValidN_2) begin
      io_pop_rData_data_2 <= inputsAdapter_1_crossclock_fifo_io_pop_payload_data;
      ...
      io_pop_rData_last_2 <= inputsAdapter_1_crossclock_fifo_io_pop_payload_last;
    end
    if(io_pop_s2mPipe_ready_2) begin
      io_pop_s2mPipe_rData_data_2 <= io_pop_s2mPipe_payload_data_2;
      io_pop_s2mPipe_rData_mask_1 <= io_pop_s2mPipe_payload_mask_1;
      io_pop_s2mPipe_rData_sink_1 <= io_pop_s2mPipe_payload_sink_1;
      io_pop_s2mPipe_rData_last_2 <= io_pop_s2mPipe_payload_last_2;
    end
    ...
    if(io_outputs_2_rValidN) begin
      io_outputs_2_rData_data <= core_io_outputs_2_payload_data;
      io_outputs_2_rData_mask <= core_io_outputs_2_payload_mask;
      io_outputs_2_rData_sink <= core_io_outputs_2_payload_sink;
      io_outputs_2_rData_last <= core_io_outputs_2_payload_last;
    end
    if(io_outputs_2_s2mPipe_ready) begin
      io_outputs_2_s2mPipe_rData_data <= io_outputs_2_s2mPipe_payload_data;
      io_outputs_2_s2mPipe_rData_mask <= io_outputs_2_s2mPipe_payload_mask;
      io_outputs_2_s2mPipe_rData_sink <= io_outputs_2_s2mPipe_payload_sink;
      io_outputs_2_s2mPipe_rData_last <= io_outputs_2_s2mPipe_payload_last;
    end
  end
...
module EfxDMA_StreamFifoCC_4 (
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_11 pushToPopGray_buffercc (
...
module EfxDMA_StreamFifo_3 (
  ...
  reg        [130:0]  logic_ram_spinal_port1;
  wire       [130:0]  _zz_logic_ram_port;
  reg                 _zz_1;
  ...
  wire       [130:0]  _zz_logic_pop_sync_readPort_rsp_data;
  ...
  assign logic_pop_sync_readPort_rsp_data = _zz_logic_pop_sync_readPort_rsp_data[127 : 0];
  assign logic_pop_sync_readPort_rsp_resp = _zz_logic_pop_sync_readPort_rsp_data[129 : 128];
  assign logic_pop_sync_readPort_rsp_last = _zz_logic_pop_sync_readPort_rsp_data[130];
...
module EfxDMA_BmbSourceRemover (
  ...
  output wire [31:0]   io_output_cmd_payload_fragment_address,
  output wire [11:0]   io_output_cmd_payload_fragment_length,
  output wire [24:0]   io_output_cmd_payload_fragment_context,
  input  wire          io_output_rsp_valid,
  output wire          io_output_rsp_ready,
  input  wire          io_output_rsp_payload_last,
  input  wire [0:0]    io_output_rsp_payload_fragment_opcode,
  input  wire [127:0]  io_output_rsp_payload_fragment_data,
  input  wire [24:0]   io_output_rsp_payload_fragment_context
);
  ...
  wire       [24:0]   _zz_rspContext_source;
  ...
  assign rspContext_context = _zz_rspContext_source[24 : 2];
  assign io_input_rsp_valid = io_output_rsp_valid;
  assign io_output_rsp_ready = io_input_rsp_ready;
  assign io_input_rsp_payload_last = io_output_rsp_payload_last;
  assign io_input_rsp_payload_fragment_opcode = io_output_rsp_payload_fragment_opcode;
...
module EfxDMA_Core (
  ...
  output wire [1:0]    io_read_cmd_payload_fragment_source,
  ...
  output wire [63:0]   io_outputs_2_payload_data,
  output wire [7:0]    io_outputs_2_payload_mask,
  output wire [3:0]    io_outputs_2_payload_sink,
  ...
  wire       [16:0]   _zz_channels_1_fifo_pop_withoutOverride_exposed;
  ...
  wire       [4:0]    _zz_channels_2_fifo_pop_bytesIncr_value_3;
  ...
  wire       [13:0]   _zz_channels_4_fifo_push_ptrIncr_value;
  wire       [1:0]    _zz_channels_4_fifo_push_ptrIncr_value_1;
  wire       [16:0]   _zz_channels_4_fifo_pop_bytesIncr_value_1;
  wire       [4:0]    _zz_channels_4_fifo_pop_bytesIncr_value_2;
  wire       [4:0]    _zz_channels_4_fifo_pop_bytesIncr_value_3;
  ...
  reg        [16:0]   channels_1_fifo_pop_withoutOverride_exposed;
  ...
  reg        [1:0]    channels_1_pop_b2s_portId;
  ...
  wire                when_DmaSg_l562_2;
  reg                 channels_4_readyForChannelCompletion;
  wire                when_DmaSg_l566_2;
  wire                when_DmaSg_l575_4;
  reg                 _zz_when_DmaSg_l593_4;
  wire                when_DmaSg_l578_4;
  ...
  reg        [127:0]  memory_core_io_reads_3_rsp_rData_data;
  reg        [15:0]   memory_core_io_reads_3_rsp_rData_mask;
  ...
  assign _zz_channels_0_pop_b2m_selfFlush = {10'd0, channels_0_fifo_pop_bytes};
  ...
  assign _zz_channels_2_push_m2b_loadRequest_1 = (channels_2_push_m2b_bytePerBurst >>> 2'd3);
  assign _zz_channels_2_push_m2b_loadRequest = {5'd0, _zz_channels_2_push_m2b_loadRequest_1};
  assign _zz_when_DmaSg_l486_1 = {14'd0, channels_2_push_m2b_bytePerBurst};
  ...
  assign _zz_channels_3_pop_b2m_selfFlush = {10'd0, channels_3_fifo_pop_bytes};
  ...
  assign _zz_channels_3_pop_b2m_address = (channels_3_pop_b2m_address - _zz_channels_3_pop_b2m_address_1);
  assign _zz_channels_3_pop_b2m_address_1 = {6'd0, channels_3_bytes};
  ...
  assign _zz_channels_4_push_m2b_loadRequest_1 = (channels_4_push_m2b_bytePerBurst >>> 2'd3);
  assign _zz_channels_4_push_m2b_loadRequest = {5'd0, _zz_channels_4_push_m2b_loadRequest_1};
  assign _zz_when_DmaSg_l486_2 = {14'd0, channels_4_push_m2b_bytePerBurst};
  assign _zz_channels_4_push_m2b_address = (channels_4_push_m2b_address - _zz_channels_4_push_m2b_address_1);
  assign _zz_channels_4_push_m2b_address_1 = {6'd0, channels_4_bytes};
  ...
  assign _zz_channels_1_fifo_push_ptrIncr_value_1 = ((memory_core_io_writes_2_cmd_fire && (m2b_rsp_context_channel == 2'b00)) ? 2'b10 : 2'b00);
  ...
  assign _zz_channels_2_fifo_push_ptrIncr_value_1 = ((memory_core_io_writes_2_cmd_fire && (m2b_rsp_context_channel == 2'b01)) ? 2'b10 : 2'b00);
  assign _zz_channels_2_fifo_push_ptrIncr_value = {12'd0, _zz_channels_2_fifo_push_ptrIncr_value_1};
  assign _zz_channels_2_fifo_pop_bytesIncr_value_2 = (_zz_channels_2_fifo_pop_bytesIncr_value ? _zz_channels_2_fifo_pop_bytesIncr_value_3 : 5'h0);
  assign _zz_channels_2_fifo_pop_bytesIncr_value_1 = {12'd0, _zz_channels_2_fifo_pop_bytesIncr_value_2};
  assign _zz_channels_2_fifo_pop_bytesIncr_value_3 = (m2b_writeRsp_context_loadByteInNextBeat + 5'h01);
  assign _zz_channels_2_fifo_pop_ptrIncr_value_1 = ((b2s_1_cmd_channelsOh[0] && memory_core_io_reads_1_cmd_ready) ? 1'b1 : 1'b0);
  assign _zz_channels_2_fifo_pop_ptrIncr_value = {13'd0, _zz_channels_2_fifo_pop_ptrIncr_value_1};
  assign _zz_channels_3_fifo_push_ptrIncr_value_1 = ((when_DmaSg_l665_1 && (|s2b_1_cmd_sinkHalted_payload_mask)) ? 1'b1 : 1'b0);
  assign _zz_channels_3_fifo_push_ptrIncr_value = {13'd0, _zz_channels_3_fifo_push_ptrIncr_value_1};
  assign _zz_channels_3_fifo_pop_bytesIncr_value_2 = (_zz_channels_3_fifo_pop_bytesIncr_value ? s2b_1_rsp_context_bytes : 4'b0000);
  assign _zz_channels_3_fifo_pop_bytesIncr_value_1 = {13'd0, _zz_channels_3_fifo_pop_bytesIncr_value_2};
  assign _zz_channels_3_fifo_pop_ptrIncr_value_1 = ((b2m_fsm_cmd_doPtrIncr && (b2m_fsm_sel_channel == 1'b1)) ? 2'b10 : 2'b00);
  assign _zz_channels_3_fifo_pop_ptrIncr_value = {12'd0, _zz_channels_3_fifo_pop_ptrIncr_value_1};
  assign _zz_channels_4_fifo_push_ptrIncr_value_1 = ((memory_core_io_writes_2_cmd_fire && (m2b_rsp_context_channel == 2'b10)) ? 2'b10 : 2'b00);
  assign _zz_channels_4_fifo_push_ptrIncr_value = {12'd0, _zz_channels_4_fifo_push_ptrIncr_value_1};
  assign _zz_channels_4_fifo_pop_bytesIncr_value_2 = (_zz_channels_4_fifo_pop_bytesIncr_value ? _zz_channels_4_fifo_pop_bytesIncr_value_3 : 5'h0);
  assign _zz_channels_4_fifo_pop_bytesIncr_value_1 = {12'd0, _zz_channels_4_fifo_pop_bytesIncr_value_2};
  assign _zz_channels_4_fifo_pop_bytesIncr_value_3 = (m2b_writeRsp_context_loadByteInNextBeat + 5'h01);
  assign _zz_channels_4_fifo_pop_ptrIncr_value_1 = ((b2s_2_cmd_channelsOh[0] && memory_core_io_reads_2_cmd_ready) ? 1'b1 : 1'b0);
  ...
  EfxDMA_DmaMemoryCore memory_core (
    ...
    .io_writes_1_cmd_payload_priority (channels_3_priority[1:0]                         ), //i
    ...
    .io_reads_1_cmd_payload_priority  (channels_2_priority[1:0]                         ), //i
    ...
    .io_reads_2_cmd_payload_priority  (channels_4_priority[1:0]                         ), //i
  ...
  always @(*) begin
    case(m2b_cmd_s0_priority_chosen)
      2'b00 : _zz_m2b_cmd_s0_priority_weightLast = (channels_1_weight == m2b_cmd_s0_priority_counter);
      2'b01 : _zz_m2b_cmd_s0_priority_weightLast = (channels_2_weight == m2b_cmd_s0_priority_counter);
      default : _zz_m2b_cmd_s0_priority_weightLast = (channels_4_weight == m2b_cmd_s0_priority_counter);
    endcase
  end
  ...
  always @(*) begin
    case(m2b_rsp_context_channel)
      2'b00 : _zz_io_writes_2_cmd_payload_address = channels_1_fifo_push_ptrWithBase;
      2'b01 : _zz_io_writes_2_cmd_payload_address = channels_2_fifo_push_ptrWithBase;
      default : _zz_io_writes_2_cmd_payload_address = channels_4_fifo_push_ptrWithBase;
    endcase
  end
  ...
  always @(*) begin
    case(b2m_fsm_arbiter_logic_priority_chosen)
      ...
      default : _zz_b2m_fsm_arbiter_logic_priority_weightLast = (channels_3_weight == b2m_fsm_arbiter_logic_priority_counter);
    endcase
  end
  ...
  assign channels_0_fifo_words = 14'h00ff;
  ...
  assign when_DmaSg_l523 = ((channels_0_pop_b2m_memPending == 4'b0000) && (channels_0_fifo_pop_bytes == 17'h0));
  ...
  assign channels_1_fifo_base = 14'h0100;
  assign channels_1_fifo_words = 14'h00ff;
  always @(*) begin
  ...
  assign channels_2_fifo_base = 14'h0200;
  assign channels_2_fifo_words = 14'h00ff;
  always @(*) begin
  ...
  assign channels_2_push_m2b_bytePerBurst = 12'h3ff;
  always @(*) begin
  ...
  assign when_DmaSg_l474_1 = (channels_2_pop_b2s_veryLastTrigger && channels_2_pop_b2s_last);
  assign when_DmaSg_l483_1 = ((((channels_2_descriptorValid && (! channels_2_pop_memory)) && channels_2_push_memory) && channels_2_push_m2b_loadDone) && (channels_2_push_m2b_memPending == 4'b0000));
  assign when_DmaSg_l486_1 = (((! channels_2_pop_memory) && channels_2_pop_b2s_veryLastValid) && (channels_2_push_m2b_bytesLeft <= _zz_when_DmaSg_l486_1));
  assign when_DmaSg_l562_1 = (channels_2_push_m2b_memPending != 4'b0000);
  always @(*) begin
  ...
  assign when_DmaSg_l566_1 = ((! channels_2_pop_memory) && (! channels_2_fifo_pop_empty));
  ...
  assign channels_3_fifo_base = 14'h0300;
  assign channels_3_fifo_words = 14'h00ff;
  ...
  assign when_DmaSg_l409_1 = (channels_3_channelStart || channels_3_fifo_pop_withOverride_unload);
  ...
  assign when_DmaSg_l457_1 = (channels_3_push_s2b_packetEvent && channels_3_push_s2b_completionOnLast);
  assign channels_3_pop_b2m_bytePerBurst = 12'h1ff;
  always @(*) begin
  ...
  assign when_DmaSg_l505_1 = (channels_3_channelStart || channels_3_pop_b2m_fire);
  always @(*) begin
  ...
  assign channels_3_pop_b2m_request = ((((((channels_3_descriptorValid && (! channels_3_channelStop)) && (! channels_3_pop_b2m_waitFinalRsp)) && channels_3_pop_memory) && ((_zz_channels_3_pop_b2m_request < channels_3_fifo_pop_bytes) || (((channels_3_fifo_push_available < _zz_channels_3_pop_b2m_request_1) || channels_3_pop_b2m_flush) || channels_3_pop_b2m_selfFlush))) && (channels_3_fifo_pop_bytes != 17'h0)) && (channels_3_pop_b2m_memPending != 4'b1111));
  always @(*) begin
    channels_3_pop_b2m_memPendingInc = 1'b0;
    if(when_DmaSg_l758_1) begin
      if(when_DmaSg_l773_4) begin
  ...
  assign when_DmaSg_l523_1 = ((channels_3_pop_b2m_memPending == 4'b0000) && (channels_3_fifo_pop_bytes == 17'h0));
  assign when_DmaSg_l532_1 = (channels_3_descriptorValid && (! channels_3_push_memory));
  assign when_DmaSg_l547_1 = ((channels_3_descriptorValid && (channels_3_pop_b2m_memPending == 4'b0000)) && channels_3_pop_b2m_waitFinalRsp);
  assign when_DmaSg_l563_1 = (channels_3_pop_b2m_memPending != 4'b0000);
  ...
  assign when_DmaSg_l255_13 = (channels_3_descriptorValid && channels_3_descriptorCompletion);
  assign when_DmaSg_l255_14 = (! channels_3_interrupts_completion_enable);
  assign when_DmaSg_l255_15 = (channels_3_channelValid && channels_3_channelCompletion);
  assign when_DmaSg_l255_16 = (! channels_3_interrupts_onChannelCompletion_enable);
  assign when_DmaSg_l255_17 = (! channels_3_interrupts_s2mPacket_enable);
  always @(*) begin
  ...
  always @(*) begin
    ...
    if(channels_4_channelValid) begin
      if(!channels_4_channelStop) begin
        if(when_DmaSg_l575_4) begin
          if(when_DmaSg_l578_4) begin
            channels_4_descriptorStart = 1'b1;
          end
        end
      end
  ...
  always @(*) begin
    ...
    if(when_DmaSg_l562_2) begin
      channels_4_readyToStop = 1'b0;
    end
  end

  assign channels_4_fifo_base = 14'h0400;
  assign channels_4_fifo_words = 14'h00ff;
  always @(*) begin
  ...
  assign channels_4_push_m2b_bytePerBurst = 12'h1ff;
  always @(*) begin
  ...
  always @(*) begin
    ...
    if(when_DmaSg_l847) begin
      if(when_DmaSg_l848_2) begin
        channels_4_pop_b2s_veryLastTrigger = 1'b1;
      end
    end
  end

  assign when_DmaSg_l474_2 = (channels_4_pop_b2s_veryLastTrigger && channels_4_pop_b2s_last);
  assign when_DmaSg_l483_2 = ((((channels_4_descriptorValid && (! channels_4_pop_memory)) && channels_4_push_memory) && channels_4_push_m2b_loadDone) && (channels_4_push_m2b_memPending == 4'b0000));
  assign when_DmaSg_l486_2 = (((! channels_4_pop_memory) && channels_4_pop_b2s_veryLastValid) && (channels_4_push_m2b_bytesLeft <= _zz_when_DmaSg_l486_2));
  assign when_DmaSg_l562_2 = (channels_4_push_m2b_memPending != 4'b0000);
  always @(*) begin
    channels_4_readyForChannelCompletion = 1'b1;
    if(when_DmaSg_l566_2) begin
      channels_4_readyForChannelCompletion = 1'b0;
    end
  end

  assign when_DmaSg_l566_2 = ((! channels_4_pop_memory) && (! channels_4_fifo_pop_empty));
  assign when_DmaSg_l575_4 = (! channels_4_descriptorValid);
  always @(*) begin
    _zz_when_DmaSg_l593_4 = 1'b1;
    if(when_DmaSg_l578_4) begin
      _zz_when_DmaSg_l593_4 = 1'b0;
    end
    if(channels_4_ctrl_kick) begin
      _zz_when_DmaSg_l593_4 = 1'b0;
    end
  ...
  assign when_DmaSg_l578_4 = (channels_4_selfRestart && (! channels_4_ctrl_kick));
  ...
  assign when_DmaSg_l255_18 = (channels_4_descriptorValid && channels_4_descriptorCompletion);
  assign when_DmaSg_l255_19 = (! channels_4_interrupts_completion_enable);
  assign when_DmaSg_l255_20 = (channels_4_channelValid && channels_4_channelCompletion);
  assign when_DmaSg_l255_21 = (! channels_4_interrupts_onChannelCompletion_enable);
  ...
  assign s2b_1_cmd_channelsOh = ((((channels_3_channelValid && (s2b_1_cmd_first || (! channels_3_push_s2b_waitFirst))) && (! channels_3_push_memory)) && 1'b1) && (io_inputs_1_payload_sink == 4'b0000));
  assign s2b_1_cmd_noHit = (! (|s2b_1_cmd_channelsOh));
  assign s2b_1_cmd_channelsFull = (channels_3_s2b_full || (channels_3_push_s2b_packetLock && io_inputs_1_payload_last));
  always @(*) begin
  ...
  assign memory_core_io_writes_1_cmd_payload_address = channels_3_fifo_push_ptrWithBase[12:0];
  ...
  assign _zz_channels_3_fifo_pop_bytesIncr_value = (memory_core_io_writes_1_rsp_valid && s2b_1_rsp_context_channel[0]);
  assign when_DmaSg_l679_1 = (_zz_channels_3_fifo_pop_bytesIncr_value && s2b_1_rsp_context_packet);
  assign when_DmaSg_l681_1 = (_zz_channels_3_fifo_pop_bytesIncr_value && s2b_1_rsp_context_flush);
  assign when_DmaSg_l682_1 = (_zz_channels_3_fifo_pop_bytesIncr_value && s2b_1_rsp_context_packet);
  assign b2s_0_cmd_channelsOh = (((channels_1_channelValid && (! channels_1_pop_memory)) && (channels_1_pop_b2s_portId == 2'b00)) && (! channels_1_fifo_pop_empty));
  ...
  assign b2s_1_cmd_channelsOh = (((channels_2_channelValid && (! channels_2_pop_memory)) && (channels_2_pop_b2s_portId == 2'b00)) && (! channels_2_fifo_pop_empty));
  assign b2s_1_cmd_veryLastPtr = channels_2_pop_b2s_veryLastPtr;
  assign b2s_1_cmd_address = channels_2_fifo_pop_ptrWithBase;
  assign b2s_1_cmd_context_channel = b2s_1_cmd_channelsOh;
  assign b2s_1_cmd_context_veryLast = ((channels_2_pop_b2s_veryLastValid && (b2s_1_cmd_address[13 : 1] == b2s_1_cmd_veryLastPtr[13 : 1])) && (b2s_1_cmd_address[0 : 0] == 1'b1));
  assign b2s_1_cmd_context_endPacket = channels_2_pop_b2s_veryLastEndPacket;
  ...
  assign io_outputs_1_payload_sink = channels_2_pop_b2s_sinkId;
  ...
  assign b2s_2_cmd_channelsOh = (((channels_4_channelValid && (! channels_4_pop_memory)) && (channels_4_pop_b2s_portId == 2'b00)) && (! channels_4_fifo_pop_empty));
  assign b2s_2_cmd_veryLastPtr = channels_4_pop_b2s_veryLastPtr;
  assign b2s_2_cmd_address = channels_4_fifo_pop_ptrWithBase;
  assign b2s_2_cmd_context_channel = b2s_2_cmd_channelsOh;
  assign b2s_2_cmd_context_veryLast = ((channels_4_pop_b2s_veryLastValid && (b2s_2_cmd_address[13 : 1] == b2s_2_cmd_veryLastPtr[13 : 1])) && (b2s_2_cmd_address[0 : 0] == 1'b1));
  assign b2s_2_cmd_context_endPacket = channels_4_pop_b2s_veryLastEndPacket;
  ...
  assign io_outputs_2_payload_sink = channels_4_pop_b2s_sinkId;
  ...
  assign when_DmaSg_l725_2 = (io_outputs_2_fire && b2s_2_rsp_context_veryLast);
  assign when_DmaSg_l726_2 = b2s_2_rsp_context_channel[0];
  assign _zz_m2b_cmd_s0_priority_masked = channels_1_push_m2b_loadRequest;
  assign _zz_m2b_cmd_s0_priority_masked_1 = channels_1_priority;
  assign _zz_m2b_cmd_s0_priority_masked_2 = channels_2_push_m2b_loadRequest;
  assign _zz_m2b_cmd_s0_priority_masked_3 = channels_2_priority;
  assign _zz_m2b_cmd_s0_priority_masked_4 = channels_4_priority;
  ...
  assign _zz_m2b_cmd_s0_priority_masked_7 = (((! channels_4_push_m2b_loadRequest) || ((_zz_m2b_cmd_s0_priority_masked_5 ? _zz_m2b_cmd_s0_priority_masked : _zz_m2b_cmd_s0_priority_masked_2) && (_zz_m2b_cmd_s0_priority_masked_4 < _zz_m2b_cmd_s0_priority_masked_6))) ? _zz_m2b_cmd_s0_priority_masked_6 : _zz_m2b_cmd_s0_priority_masked_4);
  assign m2b_cmd_s0_priority_masked = {(channels_4_push_m2b_loadRequest && (channels_4_priority == _zz_m2b_cmd_s0_priority_masked_7)),{(channels_2_push_m2b_loadRequest && (channels_2_priority == _zz_m2b_cmd_s0_priority_masked_7)),(channels_1_push_m2b_loadRequest && (channels_1_priority == _zz_m2b_cmd_s0_priority_masked_7))}};
  ...
  assign when_DmaSg_l760 = (|{channels_4_push_m2b_loadRequest,{channels_2_push_m2b_loadRequest,channels_1_push_m2b_loadRequest}});
  assign when_DmaSg_l763 = (2'b00 == _zz_m2b_cmd_s0_priority_masked_7);
  assign when_DmaSg_l763_1 = (2'b01 == _zz_m2b_cmd_s0_priority_masked_7);
  assign when_DmaSg_l763_2 = (2'b10 == _zz_m2b_cmd_s0_priority_masked_7);
  assign when_DmaSg_l763_3 = (2'b11 == _zz_m2b_cmd_s0_priority_masked_7);
  assign when_DmaSg_l773 = (channels_1_push_m2b_loadRequest && m2b_cmd_s0_priority_chosenOh[0]);
  assign when_DmaSg_l773_1 = (channels_2_push_m2b_loadRequest && m2b_cmd_s0_priority_chosenOh[1]);
  assign when_DmaSg_l773_2 = (channels_4_push_m2b_loadRequest && m2b_cmd_s0_priority_chosenOh[2]);
  ...
  assign when_DmaSg_l828 = (2'b00 == m2b_cmd_s0_chosen);
  assign when_DmaSg_l828_1 = (2'b01 == m2b_cmd_s0_chosen);
  assign when_DmaSg_l828_2 = (2'b10 == m2b_cmd_s0_chosen);
  ...
  assign m2b_rsp_context_start = _zz_m2b_rsp_context_channel[5 : 2];
  assign m2b_rsp_context_stop = _zz_m2b_rsp_context_channel[9 : 6];
  assign m2b_rsp_context_length = _zz_m2b_rsp_context_channel[21 : 10];
  assign m2b_rsp_context_last = _zz_m2b_rsp_context_channel[22];
  ...
  assign when_DmaSg_l848 = (m2b_rsp_context_channel == 2'b00);
  assign when_DmaSg_l848_1 = (m2b_rsp_context_channel == 2'b01);
  assign when_DmaSg_l848_2 = (m2b_rsp_context_channel == 2'b10);
  always @(*) begin
  ...
  assign m2b_writeRsp_context_loadByteInNextBeat = _zz_m2b_writeRsp_context_last[8 : 4];
  assign _zz_channels_1_fifo_pop_bytesIncr_value = (memory_core_io_writes_2_rsp_valid && (m2b_writeRsp_context_channel == 2'b00));
  assign when_DmaSg_l893 = (_zz_channels_1_fifo_pop_bytesIncr_value && m2b_writeRsp_context_lastOfBurst);
  assign _zz_channels_2_fifo_pop_bytesIncr_value = (memory_core_io_writes_2_rsp_valid && (m2b_writeRsp_context_channel == 2'b01));
  assign when_DmaSg_l893_1 = (_zz_channels_2_fifo_pop_bytesIncr_value && m2b_writeRsp_context_lastOfBurst);
  assign _zz_channels_4_fifo_pop_bytesIncr_value = (memory_core_io_writes_2_rsp_valid && (m2b_writeRsp_context_channel == 2'b10));
  assign when_DmaSg_l893_2 = (_zz_channels_4_fifo_pop_bytesIncr_value && m2b_writeRsp_context_lastOfBurst);
  assign _zz_b2m_fsm_arbiter_logic_priority_masked = channels_0_priority;
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_1 = channels_3_priority;
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_2 = (((! channels_3_pop_b2m_request) || (channels_0_pop_b2m_request && (_zz_b2m_fsm_arbiter_logic_priority_masked_1 < _zz_b2m_fsm_arbiter_logic_priority_masked))) ? _zz_b2m_fsm_arbiter_logic_priority_masked : _zz_b2m_fsm_arbiter_logic_priority_masked_1);
  assign b2m_fsm_arbiter_logic_priority_masked = {(channels_3_pop_b2m_request && (channels_3_priority == _zz_b2m_fsm_arbiter_logic_priority_masked_2)),(channels_0_pop_b2m_request && (channels_0_priority == _zz_b2m_fsm_arbiter_logic_priority_masked_2))};
  ...
  assign when_DmaSg_l760_1 = (|{channels_3_pop_b2m_request,channels_0_pop_b2m_request});
  ...
  assign when_DmaSg_l773_3 = (channels_0_pop_b2m_request && b2m_fsm_arbiter_logic_priority_chosenOh[0]);
  assign when_DmaSg_l773_4 = (channels_3_pop_b2m_request && b2m_fsm_arbiter_logic_priority_chosenOh[1]);
  ...
  assign memory_core_io_reads_3_rsp_s2mPipe_payload_context = (memory_core_io_reads_3_rsp_rValidN ? memory_core_io_reads_3_rsp_payload_context : memory_core_io_reads_3_rsp_rData_context);
  ...
  assign when_Apb3SlaveFactory_l81_2 = ((io_ctrl_PADDR & (~ 14'h0003)) == 14'h0100);
  assign when_Apb3SlaveFactory_l81_3 = ((io_ctrl_PADDR & (~ 14'h0003)) == 14'h0190);
  assign when_Apb3SlaveFactory_l81_4 = ((io_ctrl_PADDR & (~ 14'h0003)) == 14'h0200);
  ...
  assign channels_1_fifo_pop_bytesDecr_value = 17'h0;
  ...
  always @(posedge clk) begin
    if(reset) begin
      ...
      b2m_fsm_s2 <= 1'b0;
      b2m_fsm_toggle <= 1'b0;
      memory_core_io_reads_3_rsp_rValidN <= 1'b1;
      _zz_io_flush <= 1'b0;
      ...
      if(when_DmaSg_l255_20) begin
        channels_4_interrupts_onChannelCompletion_valid <= 1'b1;
      end
      if(when_DmaSg_l255_21) begin
        channels_4_interrupts_onChannelCompletion_valid <= 1'b0;
      end
      ...
      if(memory_core_io_reads_3_rsp_valid) begin
        memory_core_io_reads_3_rsp_rValidN <= 1'b0;
      end
  ...
  always @(posedge clk) begin
    ...
    if(channels_1_channelStart) begin
      channels_1_fifo_pop_withoutOverride_exposed <= 17'h0;
    end
    if(channels_1_descriptorStart) begin
    ...
    if(channels_3_channelValid) begin
      if(!channels_3_channelStop) begin
        if(when_DmaSg_l575_3) begin
          if(when_DmaSg_l578_3) begin
            channels_3_pop_b2m_address <= (_zz_channels_3_pop_b2m_address - 32'h00000001);
          end
    ...
    if(channels_4_channelValid) begin
      if(!channels_4_channelStop) begin
        if(when_DmaSg_l575_4) begin
          if(when_DmaSg_l578_4) begin
            channels_4_push_m2b_address <= (_zz_channels_4_push_m2b_address - 32'h00000001);
          end
          if(when_DmaSg_l593_4) begin
    ...
    if(memory_core_io_reads_3_rsp_rValidN) begin
    ...
    case(io_ctrl_PADDR)
      ...
      14'h0098 : begin
        if(ctrl_doWrite) begin
          channels_1_pop_b2s_portId <= io_ctrl_PWDATA[1 : 0];
      ...
      14'h022c : begin
        if(ctrl_doWrite) begin
          ...
          channels_4_selfRestart <= io_ctrl_PWDATA[1];
        end
      end
      14'h0220 : begin
        if(ctrl_doWrite) begin
    ...
    if(when_Apb3SlaveFactory_l81_2) begin
      if(ctrl_doWrite) begin
        channels_2_push_m2b_address[31 : 0] <= io_ctrl_PWDATA[31 : 0];
      end
    end
    if(when_Apb3SlaveFactory_l81_3) begin
      if(ctrl_doWrite) begin
        channels_3_pop_b2m_address[31 : 0] <= io_ctrl_PWDATA[31 : 0];
      end
    end
    if(when_Apb3SlaveFactory_l81_4) begin
      if(ctrl_doWrite) begin
        channels_4_push_m2b_address[31 : 0] <= io_ctrl_PWDATA[31 : 0];
      end
    end
  end
...
//EfxDMA_BufferCC_10 replaced by EfxDMA_BufferCC_3
...
module EfxDMA_StreamFifo_1 (
  ...
  reg        [204:0]  logic_ram_spinal_port1;
  wire       [204:0]  _zz_logic_ram_port;
  reg                 _zz_1;
  wire                logic_ptr_doPush;
  wire                logic_ptr_doPop;
  wire                logic_ptr_full;
  ...
  wire       [11:0]   logic_push_onRam_write_payload_data_fragment_length;
  wire       [127:0]  logic_push_onRam_write_payload_data_fragment_data;
  wire       [15:0]   logic_push_onRam_write_payload_data_fragment_mask;
  wire       [14:0]   logic_push_onRam_write_payload_data_fragment_context;
  wire                logic_pop_addressGen_valid;
  reg                 logic_pop_addressGen_ready;
  wire       [7:0]    logic_pop_addressGen_payload;
  wire                logic_pop_addressGen_fire;
  ...
  wire       [11:0]   logic_pop_sync_readPort_rsp_fragment_length;
  wire       [127:0]  logic_pop_sync_readPort_rsp_fragment_data;
  wire       [15:0]   logic_pop_sync_readPort_rsp_fragment_mask;
  wire       [14:0]   logic_pop_sync_readPort_rsp_fragment_context;
  wire       [204:0]  _zz_logic_pop_sync_readPort_rsp_last;
  wire       [203:0]  _zz_logic_pop_sync_readPort_rsp_fragment_opcode;
  wire                logic_pop_sync_readArbitation_translated_valid;
  wire                logic_pop_sync_readArbitation_translated_ready;
  wire                logic_pop_sync_readArbitation_translated_payload_last;
  ...
  wire       [11:0]   logic_pop_sync_readArbitation_translated_payload_fragment_length;
  wire       [127:0]  logic_pop_sync_readArbitation_translated_payload_fragment_data;
  wire       [15:0]   logic_pop_sync_readArbitation_translated_payload_fragment_mask;
  wire       [14:0]   logic_pop_sync_readArbitation_translated_payload_fragment_context;
  wire                logic_pop_sync_readArbitation_fire;
  reg        [8:0]    logic_pop_sync_popReg;
  ...
  assign _zz_logic_pop_sync_readPort_rsp_fragment_opcode = _zz_logic_pop_sync_readPort_rsp_last[204 : 1];
  ...
  assign logic_pop_sync_readPort_rsp_fragment_length = _zz_logic_pop_sync_readPort_rsp_fragment_opcode[44 : 33];
  assign logic_pop_sync_readPort_rsp_fragment_data = _zz_logic_pop_sync_readPort_rsp_fragment_opcode[172 : 45];
  assign logic_pop_sync_readPort_rsp_fragment_mask = _zz_logic_pop_sync_readPort_rsp_fragment_opcode[188 : 173];
  assign logic_pop_sync_readPort_rsp_fragment_context = _zz_logic_pop_sync_readPort_rsp_fragment_opcode[203 : 189];
  assign logic_pop_sync_readPort_cmd_valid = logic_pop_addressGen_fire;
  assign logic_pop_sync_readPort_cmd_payload = logic_pop_addressGen_payload;
  assign logic_pop_sync_readArbitation_translated_valid = logic_pop_sync_readArbitation_valid;
  assign logic_pop_sync_readArbitation_ready = logic_pop_sync_readArbitation_translated_ready;
...
module EfxDMA_BmbContextRemover (
  ...
  wire                fifoFork_thrown_translated_fifo_io_push_ready;
  wire                fifoFork_thrown_translated_fifo_io_pop_valid;
  wire       [24:0]   fifoFork_thrown_translated_fifo_io_pop_payload_context;
  wire       [2:0]    fifoFork_thrown_translated_fifo_io_occupancy;
  wire       [2:0]    fifoFork_thrown_translated_fifo_io_availability;
  wire                fifoFork_valid;
  reg                 fifoFork_ready;
  ...
  wire       [31:0]   fifoFork_payload_fragment_address;
  wire       [11:0]   fifoFork_payload_fragment_length;
  wire       [24:0]   fifoFork_payload_fragment_context;
  wire                cmdFork_valid;
  wire                cmdFork_ready;
  wire                cmdFork_payload_last;
  wire       [0:0]    cmdFork_payload_fragment_opcode;
  wire       [31:0]   cmdFork_payload_fragment_address;
  wire       [11:0]   cmdFork_payload_fragment_length;
  wire       [24:0]   cmdFork_payload_fragment_context;
  reg                 io_input_cmd_fork2_logic_linkEnable_0;
  reg                 io_input_cmd_fork2_logic_linkEnable_1;
  wire                when_Stream_l1063;
  wire                when_Stream_l1063_1;
  ...
  wire       [31:0]   fifoFork_thrown_payload_fragment_address;
  wire       [11:0]   fifoFork_thrown_payload_fragment_length;
  wire       [24:0]   fifoFork_thrown_payload_fragment_context;
  wire                fifoFork_thrown_translated_valid;
  wire                fifoFork_thrown_translated_ready;
  wire       [24:0]   fifoFork_thrown_translated_payload_context;
  wire                popCtx_valid;
  wire                popCtx_ready;
  wire       [24:0]   popCtx_payload_context;
  reg                 fifoFork_thrown_translated_fifo_io_pop_rValid;
  reg        [24:0]   fifoFork_thrown_translated_fifo_io_pop_rData_context;
  wire                when_Stream_l375;
  wire                _zz_io_input_rsp_valid;
  ...
  EfxDMA_StreamFifo fifoFork_thrown_translated_fifo (
    .io_push_valid           (fifoFork_thrown_translated_valid                            ), //i
    .io_push_ready           (fifoFork_thrown_translated_fifo_io_push_ready               ), //o
    .io_push_payload_context (fifoFork_thrown_translated_payload_context[24:0]            ), //i
    .io_pop_valid            (fifoFork_thrown_translated_fifo_io_pop_valid                ), //o
    .io_pop_ready            (fifoFork_thrown_translated_fifo_io_pop_ready                ), //i
    .io_pop_payload_context  (fifoFork_thrown_translated_fifo_io_pop_payload_context[24:0]), //o
    .io_flush                (1'b0                                                        ), //i
    .io_occupancy            (fifoFork_thrown_translated_fifo_io_occupancy[2:0]           ), //o
    .io_availability         (fifoFork_thrown_translated_fifo_io_availability[2:0]        ), //o
    .clk                     (clk                                                         ), //i
...
module EfxDMA_DmaMemoryCore (
  ...
  output wire [127:0]  io_reads_3_rsp_payload_data,
  output wire [15:0]   io_reads_3_rsp_payload_mask,
  ...
  reg        [63:0]   _zz_read_ports_2_buffer_bufferIn_payload_data;
  reg        [7:0]    _zz_read_ports_2_buffer_bufferIn_payload_mask;
  ...
  reg        [127:0]  read_ports_3_buffer_bufferIn_rData_data;
  reg        [15:0]   read_ports_3_buffer_bufferIn_rData_mask;
  ...
  wire       [84:0]   _zz_banks_0_writeOr_value_valid_12;
  wire       [83:0]   _zz_banks_0_writeOr_value_payload_address;
  wire       [71:0]   _zz_banks_0_writeOr_value_payload_data_data;
  wire       [12:0]   _zz_banks_0_readOr_value_valid_8;
  wire       [84:0]   _zz_banks_1_writeOr_value_valid_12;
  wire       [83:0]   _zz_banks_1_writeOr_value_payload_address;
  wire       [71:0]   _zz_banks_1_writeOr_value_payload_data_data;
  wire       [12:0]   _zz_banks_1_readOr_value_valid_8;
  (* ram_style = "block" *) reg [71:0] banks_0_ram [0:4095];
  (* ram_style = "block" *) reg [71:0] banks_1_ram [0:4095];
  ...
  `ifndef SYNTHESIS
    ...
    read_ports_2_priority_value = {$urandom};
  `endif
  end
  ...
  assign read_ports_3_buffer_bufferIn_ready = read_ports_3_buffer_bufferIn_rValidN;
  assign read_ports_3_buffer_bufferOut_valid = (read_ports_3_buffer_bufferIn_valid || (! read_ports_3_buffer_bufferIn_rValidN));
  assign read_ports_3_buffer_bufferOut_payload_data = (read_ports_3_buffer_bufferIn_rValidN ? read_ports_3_buffer_bufferIn_payload_data : read_ports_3_buffer_bufferIn_rData_data);
  assign read_ports_3_buffer_bufferOut_payload_mask = (read_ports_3_buffer_bufferIn_rValidN ? read_ports_3_buffer_bufferIn_payload_mask : read_ports_3_buffer_bufferIn_rData_mask);
  assign read_ports_3_buffer_bufferOut_payload_context = (read_ports_3_buffer_bufferIn_rValidN ? read_ports_3_buffer_bufferIn_payload_context : read_ports_3_buffer_bufferIn_rData_context);
  ...
  assign when_MemoryCore_l221_4 = (read_arbiter_2_doIt && (_zz_when_MemoryCore_l221_4[0 : 0] == 1'b0));
  always @(*) begin
  ...
  assign when_MemoryCore_l221_5 = (read_arbiter_2_doIt && (_zz_when_MemoryCore_l221_5[0 : 0] == 1'b0));
  always @(*) begin
  ...
  assign when_MemoryCore_l221_6 = (read_arbiter_3_doIt && 1'b1);
  always @(*) begin
  ...
  assign when_MemoryCore_l221_7 = (read_arbiter_3_doIt && 1'b1);
  always @(*) begin
  ...
  assign _zz_banks_0_writeOr_value_payload_address = _zz_banks_0_writeOr_value_valid_12[84 : 1];
  assign banks_0_writeOr_value_payload_address = _zz_banks_0_writeOr_value_payload_address[11 : 0];
  assign _zz_banks_0_writeOr_value_payload_data_data = _zz_banks_0_writeOr_value_payload_address[83 : 12];
  ...
  assign _zz_banks_1_writeOr_value_payload_address = _zz_banks_1_writeOr_value_valid_12[84 : 1];
  assign banks_1_writeOr_value_payload_address = _zz_banks_1_writeOr_value_payload_address[11 : 0];
  assign _zz_banks_1_writeOr_value_payload_data_data = _zz_banks_1_writeOr_value_payload_address[83 : 12];
  ...
  always @(posedge clk) begin
    if(reset) begin
      ...
      if(read_ports_3_buffer_bufferIn_valid) begin
        read_ports_3_buffer_bufferIn_rValidN <= 1'b0;
      end
...
module EfxDMA_StreamFifo (
  input  wire          io_push_valid,
  output wire          io_push_ready,
  input  wire [24:0]   io_push_payload_context,
  output wire          io_pop_valid,
  input  wire          io_pop_ready,
  output wire [24:0]   io_pop_payload_context,
  input  wire          io_flush,
  output wire [2:0]    io_occupancy,
  output wire [2:0]    io_availability,
  input  wire          clk,
  ...
  reg        [24:0]   logic_ram_spinal_port1;
  wire       [2:0]    _zz_logic_ptr_notPow2_counter;
  wire       [2:0]    _zz_logic_ptr_notPow2_counter_1;
  wire       [0:0]    _zz_logic_ptr_notPow2_counter_2;
  wire       [2:0]    _zz_logic_ptr_notPow2_counter_3;
  ...
  wire                logic_push_onRam_write_valid;
  wire       [2:0]    logic_push_onRam_write_payload_address;
  wire       [24:0]   logic_push_onRam_write_payload_data_context;
  wire                logic_pop_addressGen_valid;
  reg                 logic_pop_addressGen_ready;
  wire       [2:0]    logic_pop_addressGen_payload;
  wire                logic_pop_addressGen_fire;
  ...
  wire                logic_pop_sync_readPort_cmd_valid;
  wire       [2:0]    logic_pop_sync_readPort_cmd_payload;
  wire       [24:0]   logic_pop_sync_readPort_rsp_context;
  wire                logic_pop_sync_readArbitation_translated_valid;
  wire                logic_pop_sync_readArbitation_translated_ready;
  wire       [24:0]   logic_pop_sync_readArbitation_translated_payload_context;
  wire                logic_pop_sync_readArbitation_fire;
  reg        [2:0]    logic_pop_sync_popReg;
  ...
  assign logic_pop_sync_readArbitation_valid = logic_pop_addressGen_rValid;
  assign logic_pop_sync_readArbitation_payload = logic_pop_addressGen_rData;
  assign logic_pop_sync_readPort_rsp_context = logic_ram_spinal_port1[24 : 0];
  assign logic_pop_sync_readPort_cmd_valid = logic_pop_addressGen_fire;
  assign logic_pop_sync_readPort_cmd_payload = logic_pop_addressGen_payload;
  assign logic_pop_sync_readArbitation_translated_valid = logic_pop_sync_readArbitation_valid;
  assign logic_pop_sync_readArbitation_ready = logic_pop_sync_readArbitation_translated_ready;
