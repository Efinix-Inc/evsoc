...
#define CAM_START_ADDR_SIM 0x00100000
#define GRAYSCALE_START_ADDR_SIM 0x00300000
#define SOBEL_START_ADDR_SIM 0x00500000

#define cam_array ((volatile uint32_t *)CAM_START_ADDR_SIM)
#define grayscale_array ((volatile uint32_t *)GRAYSCALE_START_ADDR_SIM)
#define sobel_array ((volatile uint32_t *)SOBEL_START_ADDR_SIM)
...
void main()
{
   ...
   //dmasg_input_memory(DMASG_BASE, DMASG_DISPLAY_MM2S_CHANNEL, CAM_START_ADDR_SIM, 16);
   //dmasg_input_memory(DMASG_BASE, DMASG_DISPLAY_MM2S_CHANNEL, GRAYSCALE_START_ADDR_SIM, 16);
   dmasg_input_memory(DMASG_BASE, DMASG_DISPLAY_MM2S_CHANNEL, SOBEL_START_ADDR_SIM, 16);
   ...
   */
   ...
   dmasg_output_memory(DMASG_BASE, DMASG_CAM1_S2MM_CHANNEL, CAM_START_ADDR_SIM, 16);
   ...
   */
   ...
   // dmasg_input_memory(DMASG_BASE, DMASG_HW_ACCEL_MM2S_CHANNEL, GRAYSCALE_START_ADDR_SIM, 16); //RISC-V performs SW RGB2grayscale conversion
   dmasg_input_memory(DMASG_BASE, DMASG_HW_ACCEL_MM2S_1_CHANNEL, CAM_START_ADDR_SIM, 16); // Camera pre-processing block performs HW RGB2grayscale conversion
   ...
   dmasg_output_memory(DMASG_BASE, DMASG_HW_ACCEL_S2MM_CHANNEL, SOBEL_START_ADDR_SIM, 16);
