...
`endif
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - Reset and PLL
  ///////////////////////////////////////////////////////////////////////////////
  wire       i_arstn;
  wire       mipi_rst;
  wire       mcuReset;
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - APB Slave 0 & APB Slave 1
  ///////////////////////////////////////////////////////////////////////////////
  //APB Slave 0
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Internal Signals - Hardware Accelerator DMA
  ///////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Camera and HDMI Reset
  ///////////////////////////////////////////////////////////////////////////////
  always @(posedge soc_clk) begin
    if (~mipi_pll_locked || ~lvds_pll_locked) begin
      hdmi_rstn <= 1'b0;
      cam1_rstn <= 1'b0;
      cam2_rstn <= 1'b0;
    end else begin
...
`endif
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // User LEDs - VSYNC Activity Indicator
  ///////////////////////////////////////////////////////////////////////////////
  reg       vsync_LED;
  reg [4:0] flash_cnt;
  ...
  always @(posedge mipi_pclk) begin
    if (~i_arstn) flash_cnt <= 5'b0;
    else 
   if (mipi_rx_inst1_ERR[9]) // bit9 will be "1"   if there is no error
   begin
      vsync_LED <= mipi_rx_inst1_VSYNC[0];
      if (!vsync_LED && mipi_rx_inst1_VSYNC[0]) flash_cnt <= flash_cnt + 1'b1;
      else if (flash_cnt == 5'b11111) flash_cnt <= 1;
    end
  end
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Camera and Display Control / Debug
  ///////////////////////////////////////////////////////////////////////////////
...
`ifdef DUAL_CAM
  ...
  assign debug_cam_display_fifo_status = {
    18'd0,
    debug_cam1_scaler_fifo_underflow,
    debug_cam1_scaler_fifo_overflow,
    debug_cam2_scaler_fifo_underflow,
    debug_cam2_scaler_fifo_overflow,
    debug_cam1_pixel_remap_fifo_underflow,
    debug_cam1_pixel_remap_fifo_overflow,
    debug_cam1_dma_fifo_underflow,
    debug_cam1_dma_fifo_overflow,
    debug_cam2_pixel_remap_fifo_underflow,
    debug_cam2_pixel_remap_fifo_overflow,
    debug_cam2_dma_fifo_underflow,
    debug_cam2_dma_fifo_overflow,
...
`endif
  ...
  `ifndef DUAL_CAM
    assign hw_accel_dma2_rready = 1'b0;
  `endif
  ...
  dma u_dma (
      ...
      // Channel 0: Camera 1 (64-bit S2MM, to DDR)
      ...
      // Channel 1: Camera 2 (64-bit S2MM, to DDR)
      ...
      // Channel 2: Display (64-bit MM2S, from DDR)
      ...
      .dat2_o_tdest (),
      .dat2_o_tlast (),
      // Channel 3: HW Accel Write (32-bit S2MM, to DDR)
      .dat3_i_clk   (axi_clk),
      ...
      // Channel 4: HW Accel Read 1 (32-bit MM2S, from DDR)
      .dat4_o_clk   (axi_clk),
      ...
      .dat4_o_tdest (),
      .dat4_o_tlast (),
      // Channel 5: HW Accel Read 2 (32-bit MM2S, from DDR)
      .dat5_o_clk   (axi_clk),
...
`else
  ...
  hw_accel_wrapper #(
      ...
      .axi_slave_rdata (hw_accel_axi_rdata),
      .axi_slave_rvalid(hw_accel_axi_rvalid),
      .dma_rready      (hw_accel_dma1_rready),
      .dma_rvalid      (hw_accel_dma1_rvalid),
      .dma_rdata       (hw_accel_dma1_rdata),
      .dma_rkeep       (hw_accel_dma1_rkeep),
      .dma_wready      (hw_accel_dma_wready),
      .dma_wvalid      (hw_accel_dma_wvalid),
      .dma_wlast       (hw_accel_dma_wlast),
      .dma_wdata       (hw_accel_dma_wdata)
