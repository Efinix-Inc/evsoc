...
::xcopy ..\source_ti60\mipi\*.sv %stamp%
...
::xcopy ..\efinity_project\isp_example_design\Ti60F225_devkit_dsi\ip\csi2_rx_cam\*.v %stamp%
::xcopy ..\efinity_project\isp_example_design\Ti60F225_devkit_dsi\ip\csi2_rx_cam\*.sv %stamp%
...
xcopy ..\efinity_project\isp_example_design\Ti60F225_devkit_dsi\ip\hbram\*.v %stamp%
xcopy ..\efinity_project\isp_example_design\Ti60F225_devkit_dsi\ip\hbram\*.sv %stamp%
