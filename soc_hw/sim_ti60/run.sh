...
cp ../efinity_project/isp_example_design/Ti60F225_devkit_dsi/ip/csi2_rx_cam/Testbench/modelsim/*.v $stamp
cp ../efinity_project/isp_example_design/Ti60F225_devkit_dsi/ip/csi2_rx_cam/Testbench/modelsim/*.sv $stamp
cp ../efinity_project/isp_example_design/Ti60F225_devkit_dsi/ip/dsi_tx_display/Testbench/modelsim/*.v $stamp
cp ../efinity_project/isp_example_design/Ti60F225_devkit_dsi/ip/dsi_tx_display/Testbench/modelsim/*.sv $stamp
...
cp ../efinity_project/isp_example_design/Ti60F225_devkit_dsi/ip/hbram/Testbench/modelsim/*.v $stamp
cp ../efinity_project/isp_example_design/Ti60F225_devkit_dsi/ip/hbram/Testbench/modelsim/*.sv $stamp
