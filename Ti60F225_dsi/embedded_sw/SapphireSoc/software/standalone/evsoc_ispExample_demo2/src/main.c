...
void ispExample_menu()
{
	...
	uart_writeStr(BSP_UART_TERMINAL, "00 : Camera Capture + DSI Display                                             \n\r");
   uart_writeStr(BSP_UART_TERMINAL, "01 : Camera Capture + RGB2Grayscale (SW) + Sobel (HW) + DSI Display           \n\r");
   uart_writeStr(BSP_UART_TERMINAL, "10 : Camera Capture + RGB2Grayscale & Sobel (HW) + DSI Display                \n\r");
   uart_writeStr(BSP_UART_TERMINAL, "11 : Camera Capture + RGB2Grayscale & Sobel & Dilation (HW) + DSI Display     \n\r");
...
void main() {
   ...
   //Array name to be modified to HyperRAM location used for display
