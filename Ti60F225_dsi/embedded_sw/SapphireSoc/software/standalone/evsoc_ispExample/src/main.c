...
*/
   ...
   msDelay(3000); //Display test content for 3 seconds
   
   uart_writeStr(BSP_UART_TERMINAL, "Done\n\r");

/*
   //Camera capture - continuous mode (to facilitate processing without frame-drop due to scaler in camera building block)
