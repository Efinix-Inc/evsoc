...
create_clock -period 13.33 dma_clk
...
# MIPI RX Constraints
#####################################
set_output_delay -clock mipi_pclk -max -4.746 [get_ports {mipi_rx_inst1_VC_ENA[3] mipi_rx_inst1_VC_ENA[2] mipi_rx_inst1_VC_ENA[1] mipi_rx_inst1_VC_ENA[0]}]
set_output_delay -clock mipi_pclk -min -2.587 [get_ports {mipi_rx_inst1_VC_ENA[3] mipi_rx_inst1_VC_ENA[2] mipi_rx_inst1_VC_ENA[1] mipi_rx_inst1_VC_ENA[0]}]
set_output_delay -clock mipi_pclk -max -5.197 [get_ports {mipi_rx_inst1_CLEAR}]
set_output_delay -clock mipi_pclk -min -2.498 [get_ports {mipi_rx_inst1_CLEAR}]
set_input_delay -clock mipi_pclk -max 6.394 [get_ports {mipi_rx_inst1_VSYNC[3] mipi_rx_inst1_VSYNC[2] mipi_rx_inst1_VSYNC[1] mipi_rx_inst1_VSYNC[0]}]
set_input_delay -clock mipi_pclk -min 3.197 [get_ports {mipi_rx_inst1_VSYNC[3] mipi_rx_inst1_VSYNC[2] mipi_rx_inst1_VSYNC[1] mipi_rx_inst1_VSYNC[0]}]
set_input_delay -clock mipi_pclk -max 6.388 [get_ports {mipi_rx_inst1_HSYNC[3] mipi_rx_inst1_HSYNC[2] mipi_rx_inst1_HSYNC[1] mipi_rx_inst1_HSYNC[0]}]
set_input_delay -clock mipi_pclk -min 3.194 [get_ports {mipi_rx_inst1_HSYNC[3] mipi_rx_inst1_HSYNC[2] mipi_rx_inst1_HSYNC[1] mipi_rx_inst1_HSYNC[0]}]
set_input_delay -clock mipi_pclk -max 6.242 [get_ports {mipi_rx_inst1_VALID}]
set_input_delay -clock mipi_pclk -min 3.121 [get_ports {mipi_rx_inst1_VALID}]
set_input_delay -clock mipi_pclk -max 6.312 [get_ports {mipi_rx_inst1_CNT[3] mipi_rx_inst1_CNT[2] mipi_rx_inst1_CNT[1] mipi_rx_inst1_CNT[0]}]
set_input_delay -clock mipi_pclk -min 3.156 [get_ports {mipi_rx_inst1_CNT[3] mipi_rx_inst1_CNT[2] mipi_rx_inst1_CNT[1] mipi_rx_inst1_CNT[0]}]
set_input_delay -clock mipi_pclk -max 6.340 [get_ports {mipi_rx_inst1_DATA[*]}]
set_input_delay -clock mipi_pclk -min 3.170 [get_ports {mipi_rx_inst1_DATA[*]}]
set_input_delay -clock mipi_pclk -max 6.257 [get_ports {mipi_rx_inst1_ERR[*]}]
set_input_delay -clock mipi_pclk -min 3.128 [get_ports {mipi_rx_inst1_ERR[*]}]
set_input_delay -clock mipi_pclk -max 6.255 [get_ports {mipi_rx_inst1_ULPS_CLK}]
set_input_delay -clock mipi_pclk -min 3.127 [get_ports {mipi_rx_inst1_ULPS_CLK}]
set_input_delay -clock mipi_pclk -max 6.264 [get_ports {mipi_rx_inst1_ULPS[3] mipi_rx_inst1_ULPS[2] mipi_rx_inst1_ULPS[1] mipi_rx_inst1_ULPS[0]}]
set_input_delay -clock mipi_pclk -min 3.132 [get_ports {mipi_rx_inst1_ULPS[3] mipi_rx_inst1_ULPS[2] mipi_rx_inst1_ULPS[1] mipi_rx_inst1_ULPS[0]}]
set_output_delay -clock mipi_pclk -max -4.746 [get_ports {mipi_rx_inst2_VC_ENA[3] mipi_rx_inst2_VC_ENA[2] mipi_rx_inst2_VC_ENA[1] mipi_rx_inst2_VC_ENA[0]}]
set_output_delay -clock mipi_pclk -min -2.587 [get_ports {mipi_rx_inst2_VC_ENA[3] mipi_rx_inst2_VC_ENA[2] mipi_rx_inst2_VC_ENA[1] mipi_rx_inst2_VC_ENA[0]}]
set_output_delay -clock mipi_pclk -max -5.197 [get_ports {mipi_rx_inst2_CLEAR}]
set_output_delay -clock mipi_pclk -min -2.498 [get_ports {mipi_rx_inst2_CLEAR}]
set_input_delay -clock mipi_pclk -max 6.394 [get_ports {mipi_rx_inst2_VSYNC[3] mipi_rx_inst2_VSYNC[2] mipi_rx_inst2_VSYNC[1] mipi_rx_inst2_VSYNC[0]}]
set_input_delay -clock mipi_pclk -min 3.197 [get_ports {mipi_rx_inst2_VSYNC[3] mipi_rx_inst2_VSYNC[2] mipi_rx_inst2_VSYNC[1] mipi_rx_inst2_VSYNC[0]}]
set_input_delay -clock mipi_pclk -max 6.388 [get_ports {mipi_rx_inst2_HSYNC[3] mipi_rx_inst2_HSYNC[2] mipi_rx_inst2_HSYNC[1] mipi_rx_inst2_HSYNC[0]}]
set_input_delay -clock mipi_pclk -min 3.194 [get_ports {mipi_rx_inst2_HSYNC[3] mipi_rx_inst2_HSYNC[2] mipi_rx_inst2_HSYNC[1] mipi_rx_inst2_HSYNC[0]}]
set_input_delay -clock mipi_pclk -max 6.242 [get_ports {mipi_rx_inst2_VALID}]
set_input_delay -clock mipi_pclk -min 3.121 [get_ports {mipi_rx_inst2_VALID}]
set_input_delay -clock mipi_pclk -max 6.312 [get_ports {mipi_rx_inst2_CNT[3] mipi_rx_inst2_CNT[2] mipi_rx_inst2_CNT[1] mipi_rx_inst2_CNT[0]}]
set_input_delay -clock mipi_pclk -min 3.156 [get_ports {mipi_rx_inst2_CNT[3] mipi_rx_inst2_CNT[2] mipi_rx_inst2_CNT[1] mipi_rx_inst2_CNT[0]}]
set_input_delay -clock mipi_pclk -max 6.340 [get_ports {mipi_rx_inst2_DATA[*]}]
set_input_delay -clock mipi_pclk -min 3.170 [get_ports {mipi_rx_inst2_DATA[*]}]
set_input_delay -clock mipi_pclk -max 6.257 [get_ports {mipi_rx_inst2_ERR[*]}]
set_input_delay -clock mipi_pclk -min 3.128 [get_ports {mipi_rx_inst2_ERR[*]}]
set_input_delay -clock mipi_pclk -max 6.255 [get_ports {mipi_rx_inst2_ULPS_CLK}]
set_input_delay -clock mipi_pclk -min 3.127 [get_ports {mipi_rx_inst2_ULPS_CLK}]
set_input_delay -clock mipi_pclk -max 6.264 [get_ports {mipi_rx_inst2_ULPS[3] mipi_rx_inst2_ULPS[2] mipi_rx_inst2_ULPS[1] mipi_rx_inst2_ULPS[0]}]
set_input_delay -clock mipi_pclk -min 3.132 [get_ports {mipi_rx_inst2_ULPS[3] mipi_rx_inst2_ULPS[2] mipi_rx_inst2_ULPS[1] mipi_rx_inst2_ULPS[0]}]
