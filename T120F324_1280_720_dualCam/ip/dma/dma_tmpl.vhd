...
port (
    ...
    ctrl_interrupts : out std_logic_vector(5 downto 0);
    ...
    dat5_o_tvalid : out std_logic;
    dat5_o_tready : in std_logic;
    dat5_o_tdata : out std_logic_vector(31 downto 0);
    dat5_o_tkeep : out std_logic_vector(3 downto 0);
    dat5_o_tdest : out std_logic_vector(3 downto 0);
    dat5_o_tlast : out std_logic;
    dat4_o_tvalid : out std_logic;
    dat4_o_tready : in std_logic;
    dat4_o_tdata : out std_logic_vector(31 downto 0);
    dat4_o_tkeep : out std_logic_vector(3 downto 0);
    dat4_o_tdest : out std_logic_vector(3 downto 0);
    dat4_o_tlast : out std_logic;
    dat2_o_tvalid : out std_logic;
    dat2_o_tready : in std_logic;
    dat2_o_tdata : out std_logic_vector(63 downto 0);
    dat2_o_tkeep : out std_logic_vector(7 downto 0);
    dat2_o_tdest : out std_logic_vector(3 downto 0);
    dat2_o_tlast : out std_logic;
    io_0_descriptorUpdate : out std_logic;
    dat5_o_clk : in std_logic;
    dat5_o_reset : in std_logic;
    dat4_o_clk : in std_logic;
    dat4_o_reset : in std_logic;
    dat3_i_clk : in std_logic;
    dat3_i_reset : in std_logic;
    dat2_o_clk : in std_logic;
    dat2_o_reset : in std_logic;
    dat1_i_clk : in std_logic;
    dat1_i_reset : in std_logic;
    dat0_i_clk : in std_logic;
    dat0_i_reset : in std_logic;
    dat3_i_tlast : in std_logic;
    dat3_i_tdata : in std_logic_vector(31 downto 0);
    dat3_i_tvalid : in std_logic;
    dat3_i_tready : out std_logic;
    dat3_i_tkeep : in std_logic_vector(3 downto 0);
    dat3_i_tdest : in std_logic_vector(3 downto 0);
    dat1_i_tvalid : in std_logic;
    dat1_i_tready : out std_logic;
    dat1_i_tdata : in std_logic_vector(63 downto 0);
    dat1_i_tkeep : in std_logic_vector(7 downto 0);
    ...
    io_4_descriptorUpdate : out std_logic;
    io_5_descriptorUpdate : out std_logic
);
end component dma;
