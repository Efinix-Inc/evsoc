...
module EfxDMA_Core (
  ...
  wire       [16:0]   _zz_channels_2_fifo_pop_withOverride_backupNext;
  wire       [16:0]   _zz_channels_2_fifo_pop_withOverride_exposed;
  wire       [26:0]   _zz_channels_2_pop_b2m_selfFlush;
  wire       [16:0]   _zz_channels_2_pop_b2m_request;
  ...
  wire       [16:0]   _zz_channels_3_fifo_pop_withoutOverride_exposed;
  ...
  reg        [16:0]   channels_2_fifo_pop_withOverride_backup;
  wire       [16:0]   channels_2_fifo_pop_withOverride_backupNext;
  reg                 channels_2_fifo_pop_withOverride_load;
  reg                 channels_2_fifo_pop_withOverride_unload;
  reg        [16:0]   channels_2_fifo_pop_withOverride_exposed;
  ...
  reg        [16:0]   channels_2_pop_b2m_decrBytes;
  ...
  reg        [16:0]   channels_3_fifo_pop_withoutOverride_exposed;
  ...
  assign _zz_channels_2_pop_b2m_selfFlush = {10'd0, channels_2_fifo_pop_bytes};
  ...
  assign channels_2_pop_b2m_request = ((((((channels_2_descriptorValid && (! channels_2_channelStop)) && (! channels_2_pop_b2m_waitFinalRsp)) && channels_2_pop_memory) && ((_zz_channels_2_pop_b2m_request < channels_2_fifo_pop_bytes) || (((channels_2_fifo_push_available < _zz_channels_2_pop_b2m_request_1) || channels_2_pop_b2m_flush) || channels_2_pop_b2m_selfFlush))) && (channels_2_fifo_pop_bytes != 17'h0)) && (channels_2_pop_b2m_memPending != 4'b1111));
  always @(*) begin
  ...
  always @(*) begin
    channels_2_pop_b2m_decrBytes = 17'h0;
    if(b2m_fsm_s1) begin
  ...
  assign when_DmaSg_l523_1 = ((channels_2_pop_b2m_memPending == 4'b0000) && (channels_2_fifo_pop_bytes == 17'h0));
  ...
  assign channels_3_fifo_pop_bytesDecr_value = 17'h0;
  ...
  always @(posedge clk) begin
    ...
    if(channels_2_channelStart) begin
      channels_2_fifo_pop_withOverride_backup <= 17'h0;
      channels_2_fifo_pop_withOverride_valid <= 1'b0;
    end
    if(channels_2_channelStart) begin
    ...
    if(channels_3_channelStart) begin
      channels_3_fifo_pop_withoutOverride_exposed <= 17'h0;
    end
    if(channels_3_descriptorStart) begin
