...
set_clock_groups -exclusive -group {i_systemClk} -group {i_mipi_txc_sclk i_mipi_txd_sclk} -group {i_hbramClk i_hbramClk_cal i_hbramClk90} -group {i_sysclk_div_2} -group {i_mipi_rx_pclk} -group {jtag_inst1_TCK} -group {i_mipi_clk} -group {i_mipi_tx_pclk} -group {i_fb_clk}
...
set_output_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~173~1}] -max 0.525 [get_ports {o_cam_d0_FIFO_RD}]
set_output_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~173~1}] -min 0.070 [get_ports {o_cam_d0_FIFO_RD}]
set_output_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~173~1}] -max 0.315 [get_ports {o_cam_d0_RST}]
set_output_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~173~1}] -min -0.140 [get_ports {o_cam_d0_RST}]
set_input_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~173~1}] -max 0.630 [get_ports {i_cam_d0_FIFO_EMPTY}]
set_input_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~173~1}] -min 0.420 [get_ports {i_cam_d0_FIFO_EMPTY}]
set_input_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~173~1}] -max 0.487 [get_ports {i_cam_d0_HS_IN_0[*]}]
set_input_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~173~1}] -min 0.325 [get_ports {i_cam_d0_HS_IN_0[*]}]
set_output_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~157~1}] -max 0.525 [get_ports {o_cam_d1_FIFO_RD}]
set_output_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~157~1}] -min 0.070 [get_ports {o_cam_d1_FIFO_RD}]
set_output_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~157~1}] -max 0.315 [get_ports {o_cam_d1_RST}]
set_output_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~157~1}] -min -0.140 [get_ports {o_cam_d1_RST}]
set_input_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~157~1}] -max 0.630 [get_ports {i_cam_d1_FIFO_EMPTY}]
set_input_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~157~1}] -min 0.420 [get_ports {i_cam_d1_FIFO_EMPTY}]
set_input_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~157~1}] -max 0.487 [get_ports {i_cam_d1_HS_IN_0[*]}]
set_input_delay -clock i_cam_ck_CLKOUT_0 -reference_pin [get_ports {i_cam_ck_CLKOUT_0~CLKOUT~157~1}] -min 0.325 [get_ports {i_cam_d1_HS_IN_0[*]}]
...
############################
# set_clock_latency -source -setup <pll_clk_latency_i_fb_clk_max -0.031> [get_ports {i_hbramClk_fb}]
# set_clock_latency -source -hold <pll_clk_latency_i_fb_clk_min -0.020> [get_ports {i_hbramClk_fb}]
# set_clock_latency -source -setup <pll_clk_latency_i_fb_clk_max -0.031> [get_ports {i_hbramClk90}]
# set_clock_latency -source -hold <pll_clk_latency_i_fb_clk_min -0.020> [get_ports {i_hbramClk90}]
# set_clock_latency -source -setup <pll_clk_latency_i_fb_clk_max -0.031> [get_ports {i_hbramClk_cal}]
# set_clock_latency -source -hold <pll_clk_latency_i_fb_clk_min -0.020> [get_ports {i_hbramClk_cal}]
# set_clock_latency -source -setup <pll_clk_latency_i_fb_clk_max -0.031> [get_ports {i_hbramClk}]
# set_clock_latency -source -hold <pll_clk_latency_i_fb_clk_min -0.020> [get_ports {i_hbramClk}]
