...
/*
   ...
   PiCam_WriteRegData(i2c_base, FRM_LENGTH_A_1, 0x0A);
   PiCam_WriteRegData(i2c_base, FRM_LENGTH_A_0, 0xA8);
   PiCam_WriteRegData(i2c_base, COARSE_INTEGRATION_TIME_A_1, 0x0A);
   PiCam_WriteRegData(i2c_base, COARSE_INTEGRATION_TIME_A_0, 0x54);
*/
